...
<div class="sc-banner">
	<div class="slide-banner">
		<!-- <div class="slide-banner-cont"><a href="#" target="_blank"><img src="http://pic.c-ctrip.com/seaclouds/banner.jpg" /></a></div> -->
		<div class="slide-banner-cont"><img src="http://pic.c-ctrip.com/seaclouds/banner.jpg" /><span class="banner-text"><span class="title">云海携程旅行大规模商品图像搜索算法大赛</span><span class="hint">5月17日 凌空SOHO携程总部</span><a href="#" target="_blank" class="btn">了解详情</a></span></div>
		<ul class="banner-nav">
			<li class="cur"></li>
			<li></li>
		</ul>
