...
<div class="sc-wrap">
	<div class="sc-layout sc-examine">
		...
		<div class="layout-title clearfix">
			<div class="float-r size-12 margin-t"><span class="weight-b">筛选：</span>
				<label><input type="radio" class="input-radio" />未提交</label>
				<label class="margin-l"><input type="radio" class="input-radio" />未审核</label>
				<label class="margin-l"><input type="radio" class="input-radio" />已审核</label>
			</div>
			<h2>用户信息管理</h2>
		</div>
